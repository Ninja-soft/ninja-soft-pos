...
- **H28 — Planes de garantía extendida:** tabla `warranty_plans` (meses extra, prima fija, comisión del vendedor) gestionable desde Productos → Garantías. Base para ofrecerla al cobrar.
