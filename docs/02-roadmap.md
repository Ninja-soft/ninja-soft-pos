...
- [~] **H54 — Catálogo de tipos de promoción.** — *Catálogo COMPLETO: NxM, precio fijo (combo), 2º ítem, **% por volumen escalonado**, **condición por medio de pago** y **regalo por compra** — todos en motor + admin + POS. Falta sólo **cupones/códigos** (sub-ítem aparte).*
