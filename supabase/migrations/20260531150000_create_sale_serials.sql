-- =============================================================================
-- 20260531150000_create_sale_serials
-- create_sale maneja productos serializados: guarda el serial en la línea y
-- marca el N° de serie como vendido (si estaba en stock) o lo registra (si se
-- tipeó uno nuevo al vender). Resto del comportamiento sin cambios.
-- =============================================================================
  ...
  loop
    ...
    if v_item.product_id is not null then
      if v_is_kit then
        ...
        -- Serializado: marcar el serial como vendido (o registrarlo si es nuevo).
