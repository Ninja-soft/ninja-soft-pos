-- =============================================================================
-- 20260531340000_create_sale_guards  (correcciones de auditoría — create_sale)
-- #4: rechaza p_discount_total < 0 (recargo encubierto / saltea tope).
-- #1: rechaza pago con vale (store_credit) por encima del total de la venta.
-- Resto idéntico a la versión viva (serial/kits/track_stock/redondeo/vale).
-- =============================================================================
