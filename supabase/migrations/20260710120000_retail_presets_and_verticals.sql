-- =============================================================================
-- 20260710120000_retail_presets_and_verticals
--
-- Bug reportado: "Configuración rápida por rubro" no tenía presets para los
-- rubros de comercio general (kiosco, minimarket, retail) — sólo gastronomía y
-- servicios — y el selector de rubro (RubroCard, 12 verticales) fallaba con
-- invalid_industry para los 6 verticales que _assert_valid_industry no conocía
-- (heladeria, cafeteria, panaderia, peluqueria, estetica, servicios).
--
-- A) _assert_valid_industry: acepta los 12 verticales de lib/verticals/config.ts.
-- B) apply_industry_preset: se recrea COMPLETA (misma lógica que la versión de
--    20260608760000_gastro_presets) sumando al catálogo c_data los presets
--    kiosco / minimarket / retail (sólo productos; NO tocan dining/delivery)
--    y sus keys al whitelist. El espejo de UI vive en modules/onboarding/presets.ts.
-- =============================================================================

-- -----------------------------------------------------------------------------
-- A) Valida contra los 12 verticales del selector de rubro.
-- -----------------------------------------------------------------------------
